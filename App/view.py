...
def printMenu():
    ...
    print("2- Cargar Tags")
    # Modificaciones para el laboratorio 1.
...
def loadBooksTags():
    """
    LLama a una función que realiza un pass
    """
...
while True:
    ...
    #Modificaciones para el laboratorio 1.
        ...
        print("Cargando información de los Book tags....")
        Booktags = loadBooksTags()
        print('Total de Book tags cargados: 0 en este primer laboratorio')
